...
export const RecipeRushPhaser: React.FC = () => {
  ...
  return (
    <div>
      ...
      <NPCModals id={portalState.context.id as number} scene={"recipe_rush"} />
